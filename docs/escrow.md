...
The [asset](https://portal.cfx.re/) you are trying to use is owned by a different [portal](https://portal.cfx.re/) account than your server's license key or the one in which you purchased it with there please transfer the [asset](https://portal.cfx.re/) to the same account as your server's license key, or restart your server.
...
- File has corrupted while downloading - re-download the file from [portal](https://portal.cfx.re/)
